...
// WithOperand adds the specific version into the status.
func (b *Builder) WithOperand(name, version string) *Builder {
...
// WithoutOperand removes the specified version from the existing status.
func (b *Builder) WithoutOperand(name string) *Builder {
